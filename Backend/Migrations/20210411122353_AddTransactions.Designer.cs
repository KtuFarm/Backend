...
namespace Backend.Migrations
{
    ...
    [Migration("20210411122353_AddTransactions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Models.Database.ProductBalance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backend.Models.Database.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backend.Models.Database.ProductBalance", b =>
                {
                    ...
                    b.HasOne("Backend.Models.Database.Transaction", "Transaction")
                        .WithMany("Medicaments")
            ...
            modelBuilder.Entity("Backend.Models.Database.Transaction", b =>
                {
                    ...
                    b.HasOne("Backend.Models.Database.Register", "Register")
                        .WithMany("Transactions")
                        .HasForeignKey("RegisterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Backend.Models.Database.User", "Pharmacist")
                        .WithMany("Transactions")
